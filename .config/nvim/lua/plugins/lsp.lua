    ...
    config = function(_)
      ...
      require("blink.cmp").setup({
        ...
        keymap = {
          ...
          ['<CR>'] = {
            function()
              if require('blink.cmp').is_menu_visible() == false then
        ...
        cmdline = {
          ...
          completion = {
            ...
            list = {
              selection = {
                preselect = false,  -- Automatically selects/highlights the first item
                auto_insert = true, -- Set to true if you also want it to auto-insert the text
              },
            },
          },
        },
